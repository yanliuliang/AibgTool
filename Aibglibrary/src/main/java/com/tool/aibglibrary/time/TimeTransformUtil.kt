...
import com.tool.aibglibrary.Annotation
import com.tool.aibglibrary.Annotation.Year_Month_Day_House_Minute_Second
...
fun Long.toDateStr(@Annotation.TimeTrans pattern: String = Year_Month_Day_House_Minute_Second): String {
    val date = Date(this)
