...
public class ImageMoveAcitivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.tianzhushan);
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                switch (event.getAction() & MotionEvent.ACTION_MASK)
                {
                    case MotionEvent.ACTION_DOWN:  //单点
                        Toast.makeText(ImageMoveAcitivity.this, bitmap.getWidth()+"*"+bitmap.getHeight(), Toast.LENGTH_LONG).show();
